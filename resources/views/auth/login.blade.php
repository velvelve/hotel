    ...
    <div class="container">
        <div class="container-wrapper">
            ...
            <div class="registration">
                <p class="text">У вас нет учетной записи? <a href="{{ route('register') }}" src="auth">
            ...
            <div class="entrance-icons">
                <div class="entrance-icons__google">
                    <a href="{{ route('social-providers.redirect', ['driver' => 'google']) }}"> <img class="img-google"
                            src="img/auth/icons_google.png" alt="google"> </a>
                </div>
                <div class="entrance-icons__vk">
                    <a href="{{ route('social-providers.redirect', ['driver' => 'vkontakte']) }}"> <img class="img-vk"

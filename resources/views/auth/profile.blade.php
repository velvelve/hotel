...
<script>
    let clickOnReservation = () => {
        ...
        for (let i = 0; i < reservationContent.length; i++) {
            reservationContent[i].style.display = 'flex'
        }
        ...
        for (let i = 0; i < bonusesContent.length; i++) {
            bonusesContent[i].style.display = 'none'
        }
    ...
    let clickOnProfile = () => {
        ...
        let reservationContent = document.getElementsByClassName('profile-leftSide__reservation')
        for (let i = 0; i < reservationContent.length; i++) {
            reservationContent[i].style.display = 'none'
        }
        let profileContent = document.getElementsByClassName('profile-leftSide__profileSettings')
        for (let i = 0; i < profileContent.length; i++) {
            profileContent[i].style.display = 'flex'
        }
        let bonusesContent = document.getElementsByClassName('profile-leftSide__bonuses')
        for (let i = 0; i < bonusesContent.length; i++) {
            bonusesContent[i].style.display = 'none'
    ...
    let clickOnBonuses = () => {
        ...
        let bonusesContent = document.getElementsByClassName('profile-leftSide__bonuses')
        for (let i = 0; i < bonusesContent.length; i++) {
            bonusesContent[i].style.display = 'flex'
        }
    ...
    let reservationClickOnCurrent = () => {
        ...
        for (let i = 0; i < reservationCurrentContent.length; i++) {
            reservationCurrentContent[i].style.display = 'flex'
        }
        let reservationPastContent = document.getElementsByClassName('reservation-content__past')
        for (let i = 0; i < reservationPastContent.length; i++) {
            reservationPastContent[i].style.display = 'none'
        }
        let reservationCanceledContent = document.getElementsByClassName('reservation-content__canceled')
        for (let i = 0; i < reservationCanceledContent.length; i++) {
            reservationCanceledContent[i].style.display = 'none'
        }
    ...
    let reservationClickOnPast = () => {
        ...
        let reservationCurrentContent = document.getElementsByClassName('reservation-content__current')
        for (let i = 0; i < reservationCurrentContent.length; i++) {
            reservationCurrentContent[i].style.display = 'none'
        }
        let reservationPastContent = document.getElementsByClassName('reservation-content__past')
        for (let i = 0; i < reservationPastContent.length; i++) {
            reservationPastContent[i].style.display = 'flex'
        }
        let reservationCanceledContent = document.getElementsByClassName('reservation-content__canceled')
        for (let i = 0; i < reservationCanceledContent.length; i++) {
            reservationCanceledContent[i].style.display = 'none'
    ...
    let reservationClickOnCanceled = () => {
        ...
        let reservationCanceledContent = document.getElementsByClassName('reservation-content__canceled')
        for (let i = 0; i < reservationCanceledContent.length; i++) {
            reservationCanceledContent[i].style.display = 'flex'
        }
    ...
    let profileClickOnGeneral = () => {
        ...
        for (let i = 0; i < profileGeneralContent.length; i++) {
            profileGeneralContent[i].style.display = 'flex'
        }
        let profileSecurityContent = document.getElementsByClassName('profileSettings-content__security')
        for (let i = 0; i < profileSecurityContent.length; i++) {
            profileSecurityContent[i].style.display = 'none'
        }
    ...
    let profileClickOnSecurity = () => {
        ...
        let profileGeneralContent = document.getElementsByClassName('profileSettings-content__general')
        for (let i = 0; i < profileGeneralContent.length; i++) {
            profileGeneralContent[i].style.display = 'none'
        }
        let profileSecurityContent = document.getElementsByClassName('profileSettings-content__security')
        for (let i = 0; i < profileSecurityContent.length; i++) {
            profileSecurityContent[i].style.display = 'flex'
        }

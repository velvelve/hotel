        ...
        <div class="container-wrapper">
            ...
            <div class="forms-registr">
                <form action="{{ route('register') }}" method="post">
                    @csrf
                    <label class="forms-title" for="first_name"
                        style="{{ $errors->has('first_name') ? 'color: red' : '' }}"> Имя
                        <input type="text" placeholder="Введите имя" name="first_name" id="name"
                    ...
                    <label class="forms-title" for="password_confirmation">
                        Подтвердите Пароль
                        <input type="password" placeholder="Введите пароль" name="password_confirmation"
                            id="password_confirmation">
                    </label>
                    <!--Согласие-->
                    <div class="approval">
                        <input class="approval-checkbox" type="checkbox" id="agreement" name="agreement" required>
                        <label class="approval-title" for="agreement">Я согласен со всеми <span><a>Условиями</a> </span> и
                            <span><a>Политикой конфединциальности</a></span></label><br>
                    </div>
            ...
            <div class="authorization">
                <p class="text authorization-text">У вас уже есть аккаунт? <a href="#" src="auth"> Авторизоваться
                    </a></p>

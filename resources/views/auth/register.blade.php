        ...
        <div class="register__wrapper">
            ...
            <div>
                ...
                <div class="forms-registr">
                    <form action="{{ route('register') }}" method="post">
                        ...
                        <div class="approval">
                            ...
                            <label class="approval-title" for="agreement">Я согласен со всеми <span><a>Условиями</a> </span>
                                и
                ...
                <div class="authorization">
                    <p class="text authorization-text">У вас уже есть аккаунт? <a href="#" src="auth">
                            Авторизоваться
                        </a></p>

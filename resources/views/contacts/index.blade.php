...
<!-- Форма для заполнения -->
        ...
        placeholder="Введите фамилию и имя" prequired><br>
                ...
                <input class="forms-input input_name" type="tel" id="phone" name="phone" placeholder="Введите номер телефона" required><br>

                <label class="forms-title" for="email">Email</label>
                <input  class="forms-input input_name" type="email" id="email" name="email" placeholder="Введите E-mail" required><br>

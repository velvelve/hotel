        ...
        <div class="slider-cart">
            ...
            <div class="slider-cart-description">
                <div class="description-wrapper">
                    ...
                    <div class="description-upperText">18 m2 | 1 кровать Queen | 2 взрослых, 1 ребенок (0-11 лет)</div>
                    <!-- Загрузка иконок -->
                    ...
                    <div class="description-lowerText">В номерах Standart есть все необходимое для комфортного пребывания и спокойного сна.</div>
                </div>
            </div>
        </div>
        <div class="slider-cart">
            ...
            <div class="slider-cart-description">
                <div class="description-wrapper">
                    ...
                    <!-- Загрузка нижнего описания -->
                    <div class="description-lowerText">Если вам необходим дополнительный комфорт, забронируйте номер Superior. В этом номере есть все, что вам нужно.</div>
                </div>
            </div>
        </div>
        <div class="slider-cart">
            ...
            <div class="slider-cart-description">
                <div class="description-wrapper">
                    ...
                    <!-- Загрузка нижнего описания -->
                    <div class="description-lowerText">Наши номера Premium подойдут тем, кто любит просторные помещения и дополнительный комфорт.</div>
                </div>
            </div>
        </div>
        <a class="slider-btn">

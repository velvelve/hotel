                ...
                <div class="section-contact_content">
                    ...
                    <div class="section-contact_connection">
                        ...
                        <ul class="connection_list">
                            <li class="section-contact_heading connection-_messenger-list">Отдел бронирования:
                                +7-900-900-99-90
                            </li>
                            <li class="section-contact_heading connection-_messenger-list">Отдел продаж:
                                +7-900-909-99-90
                            </li>
                            <li class="section-contact_heading connection-_messenger-list">Ресепшен: +7-900-909-99-99
                            </li>
                        </ul>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                            <input class="forms-input input_name" type="text" id="name" name="name"
                                   placeholder="Введите фамилию и имя"><br>
...
unset($__errorArgs, $__bag); ?>
                            <input class="forms-input input_phone" type="tel" id="phone" name="phone"
...
unset($__errorArgs, $__bag); ?>
                            <input class="forms-input input_phone" type="email" id="email" name="email"
                                   placeholder="Введите E-mail"><br>
...
unset($__errorArgs, $__bag); ?>
                                    <input class="forms-input forms-input_hotel" type="text" id="hotel" name="hotel"
                                           placeholder="Введите название Отеля"><br>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    <select class="forms-input input-feedback" id="category" name="category">
...
пожалуйста, дайте нам знать. Мы постараемся учесть ваши пожелания при наличии такой возможности."></textarea><br>
                            <!-- Чекбокс на обработку данных -->
                            <div class="title-question_approval">
                                <input class="approval" type="checkbox" id="agreement" name="agreement">
                ...
                <div class="section-two_info">
                    ...
                    <div class="info">
                        ...
                        <div class="info-groups">
                            ...
                            <p class="section-contact_heading info_list">Юридический адрес: г.Москва, ул.Никольская, д
                                12</p>
                    ...
                    <div class="section-two_social">
                        ...
                        <ul class="section-two_social-networks">
                            ...
                            <li class="section-contact_heading social-networks_list">
                                <a class="a-number" href="#"><img src="img/contacts/icons-twitter.png"
                                                                  alt="twitter"></a>
                            </li>
                            <li class="section-contact_heading social-networks_list">
                                <a class="a-number" href="#"><img src="img/contacts/icons-instagram.png"
                                                                  alt="instagram"></a>
                            </li>
                            <li class="section-contact_heading social-networks_list">

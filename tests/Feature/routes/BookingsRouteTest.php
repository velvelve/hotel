...
class BookingsRouteTest extends TestCase
{
    ...
    {
        // Находим пользователя с идентификатором 3
        $user = User::find(6);
        ...
        // Выполняем GET-запрос на маршрут '/bookings/create/{room_id}' и следуем перенаправлениям
    ...
    public function testSaveRoute()
    {
        ...
        // Устанавливаем значение id в 300
        $bookingData['id'] = 300;
